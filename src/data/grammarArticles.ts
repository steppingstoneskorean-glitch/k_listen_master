...
export const GRAMMAR_ARTICLES: GrammarArticle[] = [
  ...
  },
  {
    ...
    quiz: { videoId: '9D-8kb6RIK4', label: 'K-Content live', sentence: '이거 할 줄 아는 사람 있어?' },
  ...
  },
  {
    ...
    quiz: { videoId: '9D-8kb6RIK4', label: 'K-Content live', sentence: '형, 요리까지 해 주고 감동이에요.' },
  ...
  },
  {
    ...
    quiz: { videoId: '9D-8kb6RIK4', label: 'K-Content live', sentence: '정국아, 뭐 도와줄 거 없어?' },
  ...
  },
  {
    ...
    quiz: { videoId: '9D-8kb6RIK4', label: 'K-Content live', sentence: '배운 게 멤버의 소중함이었어.' },
