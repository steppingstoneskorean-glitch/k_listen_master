...
const TRANSLATIONS = {
  ...
  // AI 발음 채점 (Azure Pronunciation Assessment) — 한국어는 발음 정확도·유창성만, 톤(Prosody)은 추후
  'shadowing.aiScore': { en: '🤖 AI pronunciation score', ko: '🤖 AI 발음 채점', es: '🤖 Puntuación de pronunciación IA', ja: '🤖 AI発音採点' },
  'shadowing.scoring': { en: 'Listening & scoring…', ko: '듣고 채점하는 중…', es: 'Escuchando y evaluando…', ja: '聞き取り採点中…' },
  'shadowing.scoreSpeakNow': { en: 'Tap, then read the sentence aloud', ko: '누른 뒤 문장을 소리 내어 읽으세요', es: 'Toca y lee la frase en voz alta', ja: 'タップして文を声に出して読みましょう' },
  'shadowing.scoreSpeakLive': { en: '🎤 Read the sentence now!', ko: '🎤 지금 문장을 읽으세요!', es: '🎤 ¡Lee la frase ahora!', ja: '🎤 今、文を読んでください！' },
  'shadowing.scoreOverall': { en: 'Overall', ko: '종합', es: 'General', ja: '総合' },
  'shadowing.scoreAccuracy': { en: 'Accuracy', ko: '발음 정확도', es: 'Precisión', ja: '正確さ' },
  'shadowing.scoreFluency': { en: 'Fluency', ko: '유창성', es: 'Fluidez', ja: '流暢さ' },
  'shadowing.scoreCompleteness': { en: 'Completeness', ko: '완성도', es: 'Completitud', ja: '完成度' },
  'shadowing.scoreRecognized': { en: 'Heard', ko: '인식된 말', es: 'Reconocido', ja: '認識結果' },
  'shadowing.scoreAgain': { en: 'Score again', ko: '다시 채점', es: 'Evaluar otra vez', ja: 'もう一度採点' },
  'shadowing.scoreNoMatch': { en: "Couldn't catch that — try again, a bit louder and clearer.", ko: '잘 못 알아들었어요 — 조금 더 크고 또렷하게 다시 해보세요.', es: 'No se entendió; inténtalo de nuevo, más alto y claro.', ja: '聞き取れませんでした — もう少し大きくはっきり話してみてください。' },
  'shadowing.scoreFailed': { en: 'Scoring is unavailable right now.', ko: '지금은 채점을 사용할 수 없어요.', es: 'La evaluación no está disponible ahora.', ja: '現在採点を利用できません。' },
  'shadowing.scoreToneNote': { en: 'Scored on pronunciation accuracy & fluency.', ko: '발음 정확도·유창성을 반영하여 채점합니다.', es: 'Puntuado según precisión y fluidez de pronunciación.', ja: '発音の正確さと流暢さを反映して採点します。' },
  // AI 채점 동의 (음성이 Azure 로 전송되므로 사전 동의 필요)
  'shadowing.consentTitle': { en: 'Use AI pronunciation scoring?', ko: 'AI 발음 채점을 사용할까요?', es: '¿Usar la puntuación de pronunciación con IA?', ja: 'AI発音採点を使いますか？' },
  'shadowing.consentBody': {
    en: 'To score your pronunciation, your recorded voice is sent in real time to Microsoft Azure Speech (in the US) for assessment. Azure does not store the audio — it returns only the scores. This runs only with your consent, which you can withdraw anytime.',
    ko: '발음을 채점하려면 녹음된 음성이 평가를 위해 Microsoft Azure Speech(미국)로 실시간 전송됩니다. Azure는 음성을 저장하지 않고 점수만 돌려줍니다. 동의하신 경우에만 동작하며, 동의는 언제든 철회할 수 있습니다.',
    es: 'Para puntuar tu pronunciación, tu voz grabada se envía en tiempo real a Microsoft Azure Speech (en EE. UU.) para su evaluación. Azure no almacena el audio; solo devuelve las puntuaciones. Funciona solo con tu consentimiento, que puedes retirar en cualquier momento.',
    ja: '発音を採点するため、録音した音声が評価のためにMicrosoft Azure Speech（米国）へリアルタイムで送信されます。Azureは音声を保存せず、スコアのみを返します。同意した場合のみ動作し、同意はいつでも撤回できます。',
  },
  'shadowing.consentAgree': { en: 'Agree & use', ko: '동의하고 사용', es: 'Aceptar y usar', ja: '同意して使う' },
  'shadowing.consentCancel': { en: 'Not now', ko: '취소', es: 'Ahora no', ja: '今はしない' },
  'shadowing.consentPrivacy': { en: 'Privacy Policy', ko: '개인정보처리방침', es: 'Política de privacidad', ja: 'プライバシーポリシー' },
  'shadowing.consentAfter': { en: 'Recording again will now score your pronunciation.', ko: '이제 다시 녹음하면 발음이 채점됩니다.', es: 'Al grabar de nuevo, se puntuará tu pronunciación.', ja: 'もう一度録音すると発音が採点されます。' },
  'shadowing.consentReopen': { en: '🤖 Turn on AI scoring', ko: '🤖 AI 발음 채점 사용하기', es: '🤖 Activar puntuación con IA', ja: '🤖 AI発音採点を使う' },
  ...
  'errors.confirmClear': { en: 'Delete all error records?', ko: '오답 기록을 전체 삭제할까요?', es: '¿Borrar todos los registros de errores?', ja: '誤答記録をすべて削除しますか？' },
  'errors.select': { en: 'Select', ko: '선택', es: 'Seleccionar', ja: '選択' },
  'errors.cancelSelect': { en: 'Cancel', ko: '취소', es: 'Cancelar', ja: 'キャンセル' },
  'errors.deleteSelected': { en: 'Delete ({n})', ko: '선택 삭제 ({n})', es: 'Eliminar ({n})', ja: '削除 ({n})' },
  ...
  'review.compareHint': { en: 'Tap each word to compare the sounds', ko: '각 단어를 눌러 소리를 비교해 보세요', es: 'Toca cada palabra para comparar los sonidos', ja: '各単語をタップして音を聞き比べましょう' },
  'review.showMore': { en: 'Show more', ko: '더 보기', es: 'Ver más', ja: 'もっと見る' },
  'review.showLess': { en: 'Show less', ko: '접기', es: 'Ver menos', ja: '折りたたむ' },
  'review.retryInQuiz': { en: 'Retry the missed questions in the quiz →', ko: '퀴즈에서 틀린 문제 다시 풀기 →', es: 'Repite las preguntas falladas en el quiz →', ja: 'クイズで間違えた問題をやり直す →' },
  ...
  'review.next': { en: 'Next', ko: '다음', es: 'Siguiente', ja: '次へ' },
  'review.backToReview': { en: 'Back to review', ko: '복습으로 돌아가기', es: 'Volver al repaso', ja: '復習に戻る' },
  'review.openingQuiz': { en: 'Opening the quiz…', ko: '퀴즈로 이동 중…', es: 'Abriendo el cuestionario…', ja: 'クイズを開いています…' },
  'review.question': { en: 'Question', ko: '문제', es: 'Pregunta', ja: '問題' },
  'review.wrongCount': { en: '{n} missed questions', ko: '틀린 문제 {n}개', es: '{n} preguntas falladas', ja: '間違えた問題 {n}個' },
  ...
  'review.listen': { en: 'Listen', ko: '듣기', es: 'Escuchar', ja: '聞く' },
  'game.catchTheSound': { en: 'Catch the Sound', ko: '단어 맞히기', es: 'Adivina la palabra', ja: '単語あて' },
  ...
  'kpop.title': { en: '🎧 K-content Listening Quiz', ko: '🎧 K-content 듣기 퀴즈', es: '🎧 Quiz de escucha de K-content', ja: '🎧 K-contentリスニングクイズ' },
  'kpop.subtitle': {
  ...
  'kpop.reviewOnly': { en: '📝 Reviewing missed questions', ko: '📝 틀린 문제 복습 중', es: '📝 Repasando preguntas falladas', ja: '📝 間違えた問題を復習中' },
  ...
  'goal.label': { en: 'My goal', ko: '나의 목표', es: 'Mi objetivo', ja: '学習目標' },
  'goal.setPrompt': { en: 'Set a goal', ko: '목표 정하기', es: 'Define un objetivo', ja: '目標を決める' },
  'goal.preset.drama': { en: 'Watch dramas without subtitles', ko: '자막 없이 드라마 보기', es: 'Ver dramas sin subtítulos', ja: '字幕なしでドラマを見る' },
  'goal.preset.kpop': { en: 'Understand K-pop lyrics', ko: 'K-pop 가사 알아듣기', es: 'Entender letras de K-pop', ja: 'K-POPの歌詞を聞き取る' },
  'goal.preset.travel': { en: 'Travel / daily conversation', ko: '여행·일상 회화', es: 'Viajes / conversación diaria', ja: '旅行・日常会話' },
  'goal.preset.topik': { en: 'TOPIK listening', ko: 'TOPIK 듣기', es: 'Comprensión auditiva TOPIK', ja: 'TOPIK 聞き取り' },
  'goal.preset.work': { en: 'Korean for work', ko: '직장 한국어', es: 'Coreano para el trabajo', ja: '仕事の韓国語' },
  'goal.preset.custom': { en: 'Custom', ko: '직접 입력', es: 'Personalizado', ja: '自分で入力' },
  'goal.customPlaceholder': { en: 'Your goal', ko: '나의 목표를 적어보세요', es: 'Tu objetivo', ja: '目標を入力' },
  'milestone.done': { en: '🎧 {n} listening questions completed!', ko: '🎧 듣기 {n}문항 완료!', es: '🎧 ¡{n} preguntas de escucha completadas!', ja: '🎧 リスニング{n}問クリア！' },
