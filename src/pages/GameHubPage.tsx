    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-indigo-50">
        ...
        <section className="mx-auto max-w-5xl px-6 py-12">
          ...
          {/* ── Shadowing (Beta) — 맨 아래 배치 ── */}
          <button
            type="button"
            onClick={() => handlePlay('/shadowing')}
            className="group mx-auto mt-10 flex w-full max-w-2xl items-center gap-4 rounded-2xl border border-indigo-200 bg-gradient-to-r from-indigo-50 to-fuchsia-50 p-5 text-left shadow-md shadow-indigo-100/60 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg active:scale-[0.99]"
          >
